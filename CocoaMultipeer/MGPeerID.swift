...
public protocol MGPeerIDDelegate : class
{
	func peerDidUpdateDetails(peer: MGPeerID)
}
extension MGPeerIDDelegate
{
	func peerDidUpdateDetails(peer: MGPeerID) {}
}
...
@objc public final class MGPeerID: NSObject
{
	...
	internal var underlyingService: NSNetService?
	...
	public var venmoName : String?
	{
		didSet
		{
			delegate?.peerDidUpdateDetails(self)
		}
	}
	public var venmoUsername : String?
	{
		didSet
		{
			delegate?.peerDidUpdateDetails(self)
	...
	public weak var delegate: MGPeerIDDelegate?
